...
import { ArrowUpRight, ArrowDownLeft, Settings, Loader2, Trash2, Plus, X, Save, Edit2 } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-[family-name:var(--font-geist-sans)] pb-12">
