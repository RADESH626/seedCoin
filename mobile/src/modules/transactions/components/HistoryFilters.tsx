    ...
    <View className="mb-6">
      ...
      >
        ...
        >
          ...
          <Text className={`text-xs font-bold ${activeFilter === 'ALL' ? 'text-white' : 'text-zinc-400'}`}>Todos</Text>
        </Pressable>
        ...
        >
          ...
          <Text className={`text-xs font-bold ${activeFilter === 'INCOME' ? 'text-green-400' : 'text-zinc-400'}`}>Ingresos</Text>
        </Pressable>
        ...
        >
          ...
          <Text className={`text-xs font-bold ${activeFilter === 'EXPENSE' ? 'text-red-400' : 'text-zinc-400'}`}>Gastos</Text>
        </Pressable>
      </ScrollView>
    </View>
  );
