  ...
  return (
    <View className="flex-row bg-dark-800 p-1 rounded-2xl mb-8 border border-dark-700">
      ...
      >
        ...
        <Text className={`font-bold ${mode === 'EXPENSE' ? 'text-red-400' : 'text-zinc-400'}`}>Gasto</Text>
      </Pressable>
      ...
      >
        ...
        <Text className={`font-bold ${mode === 'INCOME' ? 'text-seed-400' : 'text-zinc-400'}`}>Ingreso</Text>
      </Pressable>
      ...
      >
        ...
        <Text className={`font-bold ${mode === 'TRANSFER' ? 'text-blue-400' : 'text-zinc-400'}`}>Traspaso</Text>
      </Pressable>
    </View>
  );
}
